...
class SignupPage(ctk.CTkFrame):
    ...
    def __init__(self, master=None, app=None):
        ...
        self.app = app
        self.configure(width=350, height=500, corner_radius=15, fg_color="#3e3e42")
    ...
    def create_widgets(self):
        ...
        #Header label
        self.label = ctk.CTkLabel(self, text="Create a new account", font=ctk.CTkFont(size=18, weight="bold"), text_color="white")
        self.label.grid(row=0, column=0, columnspan=2, pady=(20, 5))

        self.turn_back_btn = ctk.CTkButton(self, text='Back to login', fg_color="#007acc", width=150, command=lambda: self.app.load_login_page())
        self.turn_back_btn.grid(row=1, column=0, columnspan=2, pady=(0, 10))

        #Username label and entry
        self.username_label = ctk.CTkLabel(self, text="Username", font=ctk.CTkFont(size=14, weight="bold"), text_color="white")
        ...
        self.password_label = ctk.CTkLabel(self, text="Password", font=ctk.CTkFont(size=14, weight="bold"), text_color="white")
        ...
        self.email_label = ctk.CTkLabel(self, text="Email", font=ctk.CTkFont(size=14, weight="bold"), text_color="white")
        ...
        #Signup button
        self.button = ctk.CTkButton(self, text='Create Account', fg_color="#007acc", width=250, command=self.handle_user_registration)
